...
public class AppController {
    ...
    public ResponseEntity<AppResponse> getApp(@PathVariable UUID client_id) throws ResourceException {
        AppResponse appResponse = appService.getAppByClient_Id(client_id);
        if (!UserContext.getUserId().equals(appResponse.getUserId())) {
            throw new ResourceException("App not found for user Id " + UserContext.getUserId());
        }
